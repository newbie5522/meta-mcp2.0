      ...
      {loading ? (
        ...
        <div className="bg-white/50 border border-slate-200 border-dashed rounded-2xl p-16 text-center space-y-4 max-w-3xl mx-auto">
          ...
          <div className="space-y-2">
            <h4 className="text-sm font-bold text-slate-705">暂无素材疲劳诊断数据。当前数据库可能为空，或尚未同步素材表现 / 广告层级数据。</h4>
            <p className="text-xs text-slate-400">
              底层的规则引擎在所选日期区间内，未捕获到任何针对广告物料实体 [creative_attraction / creative / ad / frequency / CPC / CTR] 满足触发条件的诊断异常。
            </p>
          </div>
        </div>
      ) : (
